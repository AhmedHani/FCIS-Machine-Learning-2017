...
intohid  = tf.Variable( [[-0.99,1.05,0.19],[-0.43,-0.44,-0.30]])
intohidbias = tf.Variable( [1.0,1.0,1.0])
"""
...
# Write your code here
hidlay = tf.matmul(train_x ,intohid ) + intohidbias
activhidlay=tf.nn.sigmoid(hidlay)
"""
...
# Write your code here
hidtoout = tf.Variable( [[0.18],[1.11],[-0.26]])
b=tf.Variable([1.0])
"""
...
# Write your code here
YY = tf.matmul(activhidlay,hidtoout)+b
y_estimated =tf.nn.sigmoid(YY)
